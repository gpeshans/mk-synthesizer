package mk.ukim.finki.synthesizer.backend.controllers.views;

import mk.ukim.finki.synthesizer.backend.services.*;
...
public class ViewsController {
  ...
  public ModelAndView handleSinthesize(HttpServletRequest request,
